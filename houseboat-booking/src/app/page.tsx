...
export default async function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-[92svh] md:h-[100svh] min-h-[500px] flex items-center justify-center pt-20 overflow-hidden rounded-[40px] md:rounded-[80px] shadow-2xl m-2 md:m-4">
